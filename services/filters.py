...
STOP_PATTERNS = [
    ...
    r"t\.me/\+",             # Ссылки на закрытые каналы
    r"#реклама",             # Хештег рекламы
    r"реклама\.",            # Слово реклама
    r"читать дальше",        # Кликбейт
    r"читать продолжение",
    r"в комментариях👇",
    r"зарабатывать на",      # Скам/Крипта
    r"ставки на спорт",      # Беттинг
    r"доброе утро",          # Мусор
    r"спокойной ночи",       # Мусор
]

def check_stop_words(text):
    """
    Проверяет текст на наличие стоп-слов.
    True = Найдена реклама/мусор.
    """

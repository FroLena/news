...
# МОДЕЛЬ (Только название, клиент не нужен)
...
# --- НОВАЯ ФУНКЦИЯ: ПРЯМОЙ ЗАПРОС К GPT (БЕЗ БИБЛИОТЕКИ) ---
async def ask_gpt_direct(system_prompt, user_text):
    ...
    headers = {
        ...
        "HTTP-Referer": "https://amvera.ru", # Требование OpenRouter
        "X-Title": "NewsBot"
    }
...
async def send_evening_podcast():
    ...
    try:
        ...
        # Используем новую прямую функцию
...
if __name__ == '__main__':
    ...
    scheduler.start()
    print("🤖 Бот запущен! (Direct API Requests)")
